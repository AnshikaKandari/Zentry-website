      ...
      >
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
            <div className="mt-24 px-5 sm:px-10">
                ...
                <Button id="watch-trailer" title="Watch Trailer" leftIcon={<TiLocationArrow/>} containerClass="!bg-yellow-300 flex-center gap-1" onClick={() => window.open('https://www.youtube.com/watch?v=zA9r5zTllx4', '_blank')} />
            </div>
